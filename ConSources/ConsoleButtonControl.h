...
class CONSOURCES_API CConsoleButtonControl: public CConsoleControl
{
public:
	CConsoleButtonControl(CConstPointer name, CConsole* pConsole);
	CConsoleButtonControl(CConstPointer name, CConstPointer title, CConsole* pConsole);
	CConsoleButtonControl(CAbstractConsoleControlCallback* callback, CConstPointer name, CConstPointer title, CConsole* pConsole);
	CConsoleButtonControl(word taborder, CAbstractConsoleControlCallback* callback, CConstPointer name, CConstPointer title, CConsole* pConsole);
	virtual ~CConsoleButtonControl(void);

	virtual void Create(COORD pos, COORD size);
	virtual void SetFocus(bool hasFocus);

	void DrawButton(bool bHighlighted = false);
...
private:
	CConsoleButtonControl();
	CConsoleButtonControl(ConstRef(CConsoleButtonControl));
};
