...
{
public:
	CConsoleDialog(CConstPointer name, CConsole* pConsole);
	CConsoleDialog(CConstPointer name, CConstPointer title, CConsole* pConsole);
	virtual ~CConsoleDialog(void);
...
protected:
	...
	CConsoleControl* m_DefaultButton;
...
private:
	CConsoleDialog();
	CConsoleDialog(ConstRef(CConsoleDialog));
};
