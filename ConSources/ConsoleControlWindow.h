...
class CONSOURCES_API CConsoleControlWindow: public CConsoleWindow
{
public:
...
public:
	CConsoleControlWindow(CConstPointer name, CConsole* pConsole);
	CConsoleControlWindow(CConstPointer name, CConstPointer title, CConsole* pConsole);
	virtual ~CConsoleControlWindow(void);
...
private:
	CConsoleControlWindow();
	CConsoleControlWindow(ConstRef(CConsoleControlWindow));
};
