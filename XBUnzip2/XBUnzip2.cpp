...
******************************************************************************/
// XBUnzip2.cpp : Definiert den Einstiegspunkt für die Konsolenanwendung.
//
...
class XBUnzip2Application: public CApplication
{
public:
	XBUnzip2Application():
		CApplication(CStringBuffer(__FILE__LINE__ _T("XBUnzip2"))),
	    m_help(false),
		m_bArchive(false),
		m_sArchive(),
		m_bOutputFile(false),
		m_sOutputFile()
	{
        COptionCallback<XBUnzip2Application> cb(this,&XBUnzip2Application::handleHelp);
	...
	virtual int main()
	{
		...
		XBUnzip2ExtractFile(m_sArchive, m_sOutputFile);
