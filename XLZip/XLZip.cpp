...
class XLZipApplication: public CApplication
{
public:
	XLZipApplication():
		CApplication(CStringBuffer(__FILE__LINE__ _T("XLZip"))),
	    m_help(false),
		m_bArchive(false),
		m_sArchive(),
		m_bInputFile(false),
		m_sInputFile()
	{
        COptionCallback<XLZipApplication> cb(this,&XLZipApplication::handleHelp);
	...
	virtual int main()
	{
		...
		XLZipCompressFile(m_sInputFile, m_sArchive);
